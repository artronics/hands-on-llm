...
const rescueMechanic = `Roadside Rescue Mechanic
...
// The structure of this data is based on the dataset that I used to train the matching model: udacity/armenian-online-job-postings
const job_adverts = [
    {
        "Title": "Java Developer",
        "JobDescription": "We need Java Developer!"
    },
    {
        "Title": "Senior Software Engineer (Java)",
        "JobDescription": javaDev.replaceAll('\n', '\\n')
    },
    {
        "Title": "Lead Engineer (Specialist)",
        "JobDescription": leadEngineer.replaceAll('\n', '\\n')
    },
    {
        "Title": "Roadside Rescue Mechanic",
        "JobDescription": rescueMechanic.replaceAll('\n', '\\n')
    }
];

export default job_adverts;